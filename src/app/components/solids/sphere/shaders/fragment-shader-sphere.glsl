...
void main() {
  ...
  vec3 color1 = vec3(0.749, 0.749, 0.749);
  vec3 color2 = vec3(0.8784, 0.8824, 0.9804);
  vec3 finalColorSphere = mix(color1, color2, 0.5*(vNoise + 1.));
  ...
  gl_FragColor = vec4(finalColorSphere, 2.);
}
